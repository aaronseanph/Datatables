...
class Datatables
{
     ...
     */
    public static function response ($obj, Request $requestIn, ?string $collectionNameIn = null, $tableName = null): DatatablesServerSide
    {
        try {
        ...
        if ($obj instanceof Collection) {
            return (new DTBuilderCollection($obj, $request, $collectionNameIn, $tableName))->buildDT();
        }
